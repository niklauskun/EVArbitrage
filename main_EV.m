addpath(genpath('C:\Users\wenmi\Desktop\EVArbitrage'))
...
pluginPeriod = 2; % number of plug-in period per day

startPeriod1 = 10/Ts + 1; % start plug-in time period 1
endPeriod1 = 16/Ts; % end plug-in time period 1
eC1 = .1; % SoC consumption

startPeriod2 = 18/Ts + 1; % start plug-in time period 2
endPeriod2 = 32/Ts; % end plug-in time period 1
eC2 = .1; % SoC consumption

ed = .001; % SoC sample granularity
e0 = .7; % initial SoC 
ef = .8; % final SoC target level, use 0 if none
